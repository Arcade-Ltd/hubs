AFRAME.registerComponent('box', {
    ...
    update: function (oldData) {
      ...
      if (data.width !== oldData.width ||
        ...
        el.AnimatedCube.geometry = new THREE.BoxBufferGeometry(data.width, data.height,data.depth);
      }
  ...
  {
    var entity = document.querySelector('.Right');
